...
// Comments have been added to help you understand what the code is doing. You can remove them from your version if you prefer.
// We will add `db.query()` to this file as we add tables to our app. To avoid this turning into callback hell, we have used `async/await` syntax.
